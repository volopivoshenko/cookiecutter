# Generated by Powerlevel10k configuration wizard on 2022-05-30 at 09:58 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=70
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='conda:${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_PREFIX:t}}:${P9K_ANACONDA_PYTHON_VERSION}'
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=70
  ...
  ################[ goenv: go environment (https://github.com/syndbg/goenv) ]################
  # Goenv color.
  typeset -g POWERLEVEL9K_GOENV_FOREGROUND=168
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      '*pp*'    PP    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
